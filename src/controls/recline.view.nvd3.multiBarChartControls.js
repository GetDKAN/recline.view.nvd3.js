  ...
  my.multiBarChartControls = recline.View.nvd3.BaseControl.extend({
    customOptions: '<fieldset>' +
                ...
                '<div class="form-group checkbox">' +
                  ...
                  'title="Stagger Labels" data-content="Alternate the vertical position of labels if the spacing is tight along the x-axis."><i class="fa fa-question-circle" aria-hidden="true"></i></a>' +
                '</div>' +
                '<div class="form-group checkbox">' +
                  ...
                  '</label>' +
                  '<a class="help" tabindex="0" role="button" data-toggle="popover" data-trigger="focus" ' +
                  'title="Stack series display" data-content="Allow users to switch between Grouped and Stacked mode."><i class="fa fa-question-circle" aria-hidden="true"></i></a>' +
                '</div>' +
              '</fieldset>',
    events: function(){
